...
7. What will be the function output if the user runs the program two times. The first time, the user enters the "yes" and "179.67". The second time, the user enters "no".

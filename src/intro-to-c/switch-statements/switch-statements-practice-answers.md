...
@. You, a master of switch statements, successfully analyzed the code and sent your answer as a reply and went to bed. The following morning, you had another email, this time from the Time Police, congradulating you on your successful completion of the challenge and your new position as a Time Police programer. You graciously accept the offer, as they offer great benefits, good pay, and the option to work remotely or in person.
	...
	**Answer:**
	...
	int main(void)
	{
		...
		printf("Press 1 for Time Emergencies. Press 2 for time travel requests. Press 3 for
		 time ban appeals. Press 4 for time fine payment. Press 5 for human resources.\n");
		scanf("%d", &option);
	...
	// Time Travel Requests
			...
			case 2:
				printf("Press 1 for 10000 BCE - 5000 BCE. Press 2 for 4999 BCE - 0 CE. 
				Press 3 for 1 CE - 1500 CE. Press 4 for 1501 CE - Present.\n");
				scanf("%d", &subOption)

				switch(subOption)
				{
					printf("Connectuing you to")
					case 1:
	...
	//Time Ban Appeals
			...
			case 3:
				printf("Press 1 for Minor Appeals. Press 2 for Moderate Appeals. Press 3 for
				 Timeline-Altering Appeals.\n");
				scanf("%d", &subOption)
	...
	//Time Fine Payment
			...
			case 4:
				printf("Press 1 for Fine Balance. Press 2 for Billing. Press 3
				 for Payment Plans.\n");
				scanf("%d", &subOption)
	...
	// Human Resources
			...
			case 5:
				printf("Press 1 for Application Status. Press 2 for Openings.\n");
				scanf("%d", &subOption)
	...
	// Hang up
			...
			default:
				printf("That was not one of the options. Listen to them again.\n");
				break;
		}
		return 0;
	}
